...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes=None):
        ...
        self.num_classes = num_classes if num_classes is not None else cfg.MODEL.NUM_CLASSES
    ...
    def _construct_cifar(self):
        ...
        self.head = ResHead(w_in=64, nc=self.num_classes)
    ...
    def _construct_imagenet(self):
        ...
        self.head = ResHead(w_in=2048, nc=self.num_classes)
